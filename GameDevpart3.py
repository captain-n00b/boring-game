...
class player(object):
    ...
    def BulletCal(self):
        ...
        if self.right:
            self.facing = 1
        if len(bullets) < 10:
            bullets.append(projectile(round(self.hitbox[0]  + self.width// 2), round(self.hitbox[1] + self.height// 2), 6, (255, 255, 255), self.facing))


    def hit(self):
        print("HIT!!!! By Player2")
...
class player2(object):
    ...
    def BulletCal(self):
        ...
        if self.right:
            self.facing = 1
        if len(bullets) < 10:
            bullets.append(projectile(round(self.hitbox[0] + 30 + self.width// 2), round(self.hitbox[1] + self.height// 2), 6, (255, 255, 255), self.facing))

    def hit(self):
        print("HIT!!!!! By Player 1")
...
while run:
    ...
    if keys[pygame.K_e] and shootLoop == 0:
        ...
        if man.right:
            man.facing = 1
        if len(bullets) < 10:
            bullets.append(projectile(round(man.x + man.width// 2), round(man.y + man.height// 2), 6, (255, 255, 255), man.facing))'''
    ...
    if keys[pygame.K_END] and shootLoop == 0:
        ...
        if man2.right:
            man2.facing = 1
        if len(bullets) < 10:
            bullets.append(projectile(round(man2.x + man2.width// 2), round(man2.y + man2.height// 2), 6, (255, 255, 255), man2.facing))'''
